...
public class AlipayUtil {
    //https://qr.alipay.com/a6x03911ci5tmcspq3t9vd9
    // 支付宝包名
     ...
     * @return 是否成功调用
     */
    public static boolean startAlipayClient(AppCompatActivity activity, String urlCode) {
     ...
     * @return 是否成功调用
     */
    public static boolean startIntentUrl(AppCompatActivity activity, String intentFullUrl) {
        try {
