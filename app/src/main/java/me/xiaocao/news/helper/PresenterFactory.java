...
public class PresenterFactory {
    ...
    public static IZhiHuPresenter getZhihuPresenter() {
        return new ZhihuHelper();
    }

    public static IGuokrPresenter getGuokrPresenter() {
        return new GuokrHelper();
    }
}
